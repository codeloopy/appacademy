...
# the two adjacent letters that appear the
# most in the string.
...
class Hash
    # Write a method, Hash#inverse, that returns a new hash where
		#the key-value pairs are swapped
